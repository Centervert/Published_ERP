...
export type DevItemType = 'decision' | 'risk' | 'blocker' | 'milestone' | 'scope' | 'link' | 'release' | 'ticket' | 'feature';
...
export function useFeatures(documentId: string | undefined) {
  return useDevItems(documentId, 'feature');
}
